...
%%
grad_HbO = gradient(list(:,2));
grad_HbR = gradient(list(:,3));
...
for l = 1:length(list)
    ...
    dist_HbR_CCO(l,1) = abs(list(l,3) - list(l,4));
    dist_CCO_HbO(l,1) = abs(list(l,2) - list(l,4));
...
yyaxis right
plot(list(:,1),new_plot, 'LineWidth',2)
rightcolors = [0.4660 0.6740 0.1880; 0.3010 0.7450 0.9330; 0.6350 0.0780 0.1840];
colororder(rightcolors)
ylabel('Extinction Coefficient (cm^-^1mM^-^1)')

%'LineStyle', 'none' ,'marker','.', 'MarkerSize',30);
%xlim([0 200000])
%ylim([650 1000])
title({'Graph showing different five-wavelength combinations and their corresponding condition number','alongside extinction coefficients of chromophores'},'FontSize',23)
legend({'Wavelength 1', 'Wavelength 2', 'Wavelength 3', 'Wavelength 4', 'Wavelength 5', 'HbO', 'HbR', 'oxCCO'},'Location','southwest','FontSize',23)
...
yyaxis right
plot(list(:,1),grads, 'LineWidth',2)
rightcolors = [0.4660 0.6740 0.1880; 0.3010 0.7450 0.9330; 0.6350 0.0780 0.1840];
colororder(rightcolors)
ylabel('Slope of Extinction Coefficient (cm^-^1mM^-^1)')
...
legend({'Wavelength 1', 'Wavelength 2', 'Wavelength 3', 'Wavelength 4', 'Wavelength 5', 'HbO', 'HbR', 'oxCCO'},'Location','southwest','FontSize',20)
...
yyaxis right
plot(list(:,1),total_grad, 'LineWidth',2)
rightcolors = [0.4660 0.6740 0.1880; 0.3010 0.7450 0.9330; 0.6350 0.0780 0.1840];
colororder(rightcolors)
ylabel('Slope of Extinction Coefficient (cm^-^1mM^-^1)')
...
legend({'Wavelength 1', 'Wavelength 2', 'Wavelength 3', 'Wavelength 4', 'Wavelength 5', 'Sum of Slopes', 'HbR', 'oxCCO'},'Location','southwest','FontSize',20)
...
yyaxis right
plot(list(:,1),total_dist, 'LineWidth',2)
rightcolors = [0.4660 0.6740 0.1880; 0.3010 0.7450 0.9330; 0.6350 0.0780 0.1840];
colororder(rightcolors)
ylabel('Total Distance between Extinction Coefficients (cm^-^1mM^-^1)')

%'LineStyle', 'none' ,'marker','.', 'MarkerSize',30);
%xlim([0 200000])
%ylim([650 1000])
title({'Graph showing different five-wavelength combinations and their corresponding condition number','alongside the sum of the difference in extinction coefficients of chromophores'},'FontSize',16)
legend({'Wavelength 1', 'Wavelength 2', 'Wavelength 3', 'Wavelength 4', 'Wavelength 5', 'Sum of differences of excintion coefficients', 'HbR', 'oxCCO'},'Location','southwest','FontSize',16)
