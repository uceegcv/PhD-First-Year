...
%%
combos2 = nchoosek(1:length(list),9);

for l = 1:length(combos2)
    A{l} = [list(combos(l,1),2) list(combos(l,1),3) list(combos(l,1),4); list(combos(l,2),2) list(combos(l,2),3) list(combos(l,2),4); list(combos(l,3),2) list(combos(l,3),3) list(combos(l,3),4); list(combos(l,4),2) list(combos(l,4),3) list(combos(l,4),4); list(combos(l,5),2) list(combos(l,5),3) list(combos(l,5),4);list(combos(l,6),2) list(combos(l,6),3) list(combos(l,6),4);list(combos(l,7),2) list(combos(l,7),3) list(combos(l,7),4);list(combos(l,8),2) list(combos(l,8),3) list(combos(l,8),4);list(combos(l,9),2) list(combos(l,9),3) list(combos(l,9),4);];
end

for j = 1:length(A)
    condition_number(j,:) = cond(A{j});
end
...
% 
% yyaxis right
% plot(list(:,1),total_dist, 'LineWidth',1.5)
% rightcolors = [0.4660 0.6740 0.1880; 0.3010 0.7450 0.9330; 0.6350 0.0780 0.1840];
% colororder(rightcolors)
% ylabel('Total Distance between Extinction Coefficients')
% 
% %'LineStyle', 'none' ,'marker','.', 'MarkerSize',30);
% %xlim([0 200000])
% %ylim([650 1000])
